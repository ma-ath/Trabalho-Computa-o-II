...
printf ("      <FORM ACTION=\"CGIs/tozcCgiRequestPasswordReset.cgi\" METHOD=\"post\">\n");
	if (language == tozcPortuguese)
...
printf ("         </TR>\n");
printf ("         <TR>\n");
printf ("           <TD ALIGN=\"left\"><span style=\"font-family:trebuchet ms,helvetica,sans-serif;\">Email:</span></TD>\n");
printf ("           <TD><INPUT TYPE=\"text\" NAME=\"tozcEmail\"></TD>\n");
printf ("         </TR>\n");
printf ("         <TR>\n");
	if (language == tozcPortuguese)
	printf ("           <TD COLSPAN=\"2\" ALIGN=\"center\"><INPUT TYPE=\"submit\" VALUE=\"Pedir uma nova senha!\"></TD>\n");
	else
	printf ("           <TD COLSPAN=\"2\" ALIGN=\"center\"><INPUT TYPE=\"submit\" VALUE=\"Ask a new Password!\"></TD>\n");
printf ("         </TR>\n");
printf ("      </FORM>\n");
printf ("    </TABLE>\n");
printf ("    <BR>\n");
